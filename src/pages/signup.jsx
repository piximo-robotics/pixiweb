              ...
              <form class="space-y-4 md:space-y-6" onSubmit={register}>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <Link rel="noopener noreferrer" class="font-medium text-primary-500 hover:underline dark:text-primary-500" target="_blank" to="/terms">Terms and Conditions</Link> and <Link rel="noopener noreferrer" class="font-medium text-primary-500 hover:underline dark:text-primary-500" target="_blank" to="/privacy">Privacy Policy</Link></label>
                  </div>
                </div>
