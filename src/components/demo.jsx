...
export function Demo({ fixed }) {
  return (
    <>
      <div id="demo" class="relative flex flex-col items-end text-right justify-end h-auto mb-10 mx-20 rounded-xl bg-black ">
        ...
        <div class="absolute px-50 z-30 lg:col-span-5 w-2/5 space-y-2 mr-10 mb-10">
