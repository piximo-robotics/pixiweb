  ...
  return (
    <>
      <div id="CTA" class="border flex flex-col py-10 justify-center items-center text-center mx-20 my-10 h-40 rounded-xl text-xl space-y-5">
        ...
        <Link className="flex justify-center text-md leading-snug text-black hover:opacity-75 font-light" to="/signup"><button class="rounded bg-primary px-3 py-1">Sign up</button>
            </Link>
      </div>
    </>
  );
